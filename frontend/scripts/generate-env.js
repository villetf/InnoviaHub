...
const DEFAULT_DEVREG = 'http://localhost:5101';
const DEFAULT_PORTADAPT = 'http://localhost:5104';
...
const deviceRegistryUrl = process.env.NG_APP_DEVREG_URL || DEFAULT_DEVREG;
const portalAdapterUrl = process.env.NG_APP_PORTADAPT_URL || DEFAULT_PORTADAPT;
...
const content = `window.__env = {
  ...
  NG_APP_DEVREG_URL: '${deviceRegistryUrl}',
  NG_APP_PORTADAPT_URL: '${portalAdapterUrl}',
